<template>
  <div class="app-container">
    ...
    <div class="operation-buttons">
      ...
      <export-button :api-function="exportLogList" :search-params="searchParams" :export-options="getExportOptions()" v-permission="['system:log:list']" @export-success="onExportSuccess" @export-error="onExportError" />
    </div>
    ...
    >
      ...
      <el-table-column label="操作" width="180" align="center" fixed="right">
        <template slot-scope="{ row }">
          <el-button type="text" size="small" v-permission="['system:log:query']" @click="handleEdit(row)">查看</el-button>
        </template>
      </el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    ...
    async loadSysuserOptions() {
      ...
      if (!permissions.includes('*:*:*') && !permissions.includes('system:user:list')) {
        this.sysuserOptions = []
        return
      }
      try {
